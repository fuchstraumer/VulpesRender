...
namespace vpr {
    ...
    */
    ...
    MemoryBlock::MemoryBlock(VkDevice parent) : parentDevice(parent), availSize(0), freeCount(0), memory(VK_NULL_HANDLE), Size(0) {}
    ...
    void MemoryBlock::Destroy() {
        ...
        vkFreeMemory(parentDevice, memory, nullptr);
    ...
    void MemoryBlock::Unmap() {
        ...
        vkUnmapMemory(parentDevice, memory);
    }
