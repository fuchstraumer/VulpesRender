...
/**
 * Returns the MTLClearColor value corresponding to the color value in the specified 
 * VkClearValue, extracting the color value that is VkFormat for the specified VkFormat.
 */
...
/** Returns the Metal texture usage from the specified Vulkan image usage. */
MTLTextureUsage mvkMTLTextureUsageFromVkImageUsageFlags(VkImageUsageFlags vkImageUsageFlags);

/** Returns the Metal MTLTextureType corresponding to the specified Vulkan VkImageViewType. */
...
#define MVK_VK_MEMORY_TYPE_METAL_SHARED		(VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT | VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT)
